...
public class ElevatorControllerImpl implements ElevatorController, ElevatorEventListener {
    ...
    private void initFloors(int numFloors) {
        ...
        for(int i = 0; i < numFloors; i ++){
            //for each floor, create a new list
            passengers.add(i, new LinkedList<>());
        }
    }
